...
bool canPolycarpusCook(ll m) {
    ...
    ll e_b = max(static_cast<ll>(0), m * c_b - n_b); // to store extra bread   slices required to cook 'm' hamburgers
...
int main() {
    ...
    ll ans; // to track max. no. of hamburgers Polycarpus can make
