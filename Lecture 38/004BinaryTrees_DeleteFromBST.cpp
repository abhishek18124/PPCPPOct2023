...
TreeNode* deleteFromBST(TreeNode* root, int key) {
	...
	if (root->val == key) {
		...
		if (root->left == NULL and root->right == NULL) {
			...
			// you are deleting a node with a single left child
			...
			// you are deleting a node with a single right child
			...
			// you are deleting a node with two child nodes
		...
		// recursively, delete the node whose value is equal to key, if present, from the leftSubtree
		...
		// recursively, delete the node whose value is equal to key, if present, from the rightSubtree
