...
public:
    ...
    // return false if you want a to be given higher priority then b otherwise return true
    ...
    bool operator()(ListNode* a, ListNode* b) {
        ...
        if (a->val < b->val) {
            ...
            // you want a to be given higher priority than b
...
ListNode* mergeKSortedLinkedLists(vector<ListNode*> v) {
