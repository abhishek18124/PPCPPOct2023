...
int helperTopDown(TreeNode* root, unordered_map<TreeNode*, int>& dp) {
    ...
    if (dp.find(root) != dp.end()) {
        ...
        // you know the max profit you can get from the subtree rooted at root
    ...
    int donotRobRoot = helperTopDown(root->left, dp) + helperTopDown(root->right, dp);
    ...
    return dp[root] = max(donotRobRoot, robRoot);
